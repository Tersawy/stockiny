...
const schema = require("./schemas/PurchaseReturnSchema").obj;
	...
	status: {
		...
		custom: {
			options: async (value, { req }) => {
				...
				let status = await Status.findOne({ invoice: "purchasesReturn", _id: value });
...
let updatePurchaseReturn = { ...createPurchaseReturn, id: checkId };

exports.getPurchasesReturn = checkSchema({
...
exports.createPurchaseReturn = checkSchema(createPurchaseReturn);

exports.getPurchaseReturn = checkSchema({ id: checkId });

exports.getEditPurchaseReturn = checkSchema({ id: checkId });

exports.deletePurchaseReturn = checkSchema({ id: checkId });

exports.updatePurchaseReturn = checkSchema(updatePurchaseReturn);

exports.changePurchaseReturnStatus = checkSchema({
	id: checkId,
