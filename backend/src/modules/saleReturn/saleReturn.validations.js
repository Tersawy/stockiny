...
let updateSaleReturn = { ...createSaleReturn, id: checkId };

exports.getSalesReturn = checkSchema({
...
exports.createSaleReturn = checkSchema(createSaleReturn);

exports.getSaleReturn = checkSchema({ id: checkId });

exports.getEditSaleReturn = checkSchema({ id: checkId });

exports.deleteSaleReturn = checkSchema({ id: checkId });

exports.updateSaleReturn = checkSchema(updateSaleReturn);

exports.changeSaleReturnStatus = checkSchema({
	id: checkId,
