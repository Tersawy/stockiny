...
const schema = require("./schemas/SaleSchema").obj;
...
let createSale = {
	...
	details: {
		...
		// 			if (!d.subUnit) throw { type: "required", value: "SaleUnit" };

		// 			if (!mongoose.Types.ObjectId.isValid(d.subUnit)) throw { type: "mongoId", value: "SaleUnit" };
		// 		}
		// 	},
		// },
	},
	...
	status: {
		...
		custom: {
			options: async (value, { req }) => {
				...
				let status = await Status.findOne({ invoice: "sales", _id: value });
...
let updateSale = { ...createSale, id: checkId };

exports.getSales = checkSchema({
...
exports.createSale = checkSchema(createSale);

exports.getSale = checkSchema({ id: checkId });

exports.getEditSale = checkSchema({ id: checkId });

exports.deleteSale = checkSchema({ id: checkId });

exports.updateSale = checkSchema(updateSale);

exports.changeSaleStatus = checkSchema({
	id: checkId,
