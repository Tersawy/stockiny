	...
	>
		<g>
			<g>
				<path
					style="fill: none"
					d="M186.95,343.077l-39.367,11.362h146.668c6.629,0,12,5.373,12,12c0,6.627-5.371,12-12,12H66.541
			...
			h318.001v-211.55L192.108,340.033C190.673,341.467,188.899,342.514,186.95,343.077z"
				...
				<path
					style="fill: none"
					d="M327.089,24c-4.922,0-8.928,1.6-12.604,5.035c-0.145,0.137-0.293,0.268-0.443,0.395l-8.666,8.666
			...
			c16.182-17.318-11.684-47.783-20.609-56.707C354.897,33.346,338.821,24,327.089,24z"
				...
				<path
					style="fill: #6edd87"
					d="M107.91,235.564l77.362,77.362l180.496-180.498l-77.363-77.363L107.91,235.564z M309.38,111.454
			...
			c-4.686-4.687-4.686-12.285,0-16.971l126.773-126.772C297.095,106.768,304.694,106.768,309.38,111.454z"
				...
				<path
					style="fill: #3d6889"
					d="M165.636,255.197c2.344,2.343,5.414,3.514,8.484,3.514c3.072,0,6.142-1.172,8.486-3.514
			...
			C160.95,242.913,160.95,250.51,165.636,255.197z"
				...
				<path
					style="fill: #28a745"
					d="M417.848,76.476c-4.635-13.872-14.898-29.019-29.686-43.803C373.259,17.768,350.565,0,327.089,0
