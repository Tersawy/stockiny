<template>
	<main-content :breads="breads">
		...
		<DeleteModal ref="deleteModal" field="Warehouse" @ok="moveToTrash" />
...
export default {
	...
	mixins: [dataTableMixin("Warehouses")],

	data: () => ({
		breads: [{ title: "Dashboard", link: "/" }, { title: "Warehouses" }],

		formId: "warehouseFormModal",
