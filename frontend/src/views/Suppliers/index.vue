<template>
	<main-content :breads="breads">
		...
		<DeleteModal ref="deleteModal" field="Supplier" @ok="moveToTrash" />
...
export default {
	...
	mixins: [dataTableMixin("Suppliers")],

	data: () => ({
		breads: [{ title: "Dashboard", link: "/" }, { title: "Suppliers" }],

		formId: "supplierFormModal",
